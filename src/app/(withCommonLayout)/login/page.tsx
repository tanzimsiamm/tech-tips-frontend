    ...
    <div className="flex flex-col items-center justify-center p-6 h-full bg-gray-50 dark:bg-gray-900 shadow-2xl border border-gray-700">
      <div className="w-full max-w-md p-8 bg-white dark:bg-gray-800 rounded-lg shadow-lg">
        <div className="text-center mb-8">
          <div className="border rounded-xl p-4 bg-gray-50 dark:bg-gray-700 text-gray-800 dark:text-gray-200 border-gray-300 dark:border-gray-600 mb-6">
            <h1 className="text-lg lg:text-xl font-bold mb-3">
              Login With Demo For Testing
            </h1>
            <div className="flex flex-wrap items-center justify-center gap-4">
              <button
                className="bg-blue-600 hover:bg-blue-700 p-2 rounded-full text-sm lg:text-base text-white font-semibold transition-colors duration-200 w-full sm:w-auto px-6"
                onClick={() =>
                  setDemoUser({
        ...
        <div className="w-full">
          <form className="text-white" onSubmit={handleLogin}>
            ...
            <div className="mt-8">
              <Button
                className="w-full justify-center py-3 px-4 text-base font-semibold rounded-full text-white bg-blue-600 hover:bg-blue-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500 transition-colors duration-200 dark:bg-blue-600 dark:hover:bg-blue-700 disabled:opacity-50 disabled:cursor-not-allowed"
                disabled={loading}
                type="submit"
              >
                {loading ? (
