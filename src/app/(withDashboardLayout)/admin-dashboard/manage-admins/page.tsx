...
export default function ManageAdmins() {
  ...
  const { data, isLoading, refetch } = useGetUsersQuery({ role: "admin" });
  ...
  const updateUserInfo = (userId: string, action: "block" | "activate") => {
    ...
    Swal.fire({
      title: `Are you sure?`,
      text: `Are you going to ${actionText} this Admin?`,
      icon: "warning",
  ...
  const deleteUser = (userId: string) => {
    Swal.fire({
      title: "Are you sure?",
      text: "Are you going to delete this Admin permanently?",
      icon: "warning",
      showCancelButton: true,
      confirmButtonColor: "#3085d6",
      cancelButtonColor: "#d33",
